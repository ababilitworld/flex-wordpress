...
namespace Ababilitworld\FlexWordpress\Package\Pagination\Concrete;

(defined( 'ABSPATH' ) && defined( 'WPINC' )) || die();

use Ababilitworld\{
    FlexTraitByAbabilitworld\Standard\Standard,
    FlexWordpress\Package\Pagination\Base\Pagination as BasePagination,
    FlexWordpress\Package\Pagination\Presentation\Template\Template as PaginationTemplate,
};
