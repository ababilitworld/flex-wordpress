<?php
namespace Ababilithub\FlexWordpress\Package\Query\Posttype\V1\Manager;
...
use Ababilithub\{
    ...
    FlexWordpress\Package\Query\Posttype\V1\Concrete\Recent\Post\Query as RecentPostQuery,
};
