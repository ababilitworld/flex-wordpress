...
use Ababilithub\{
    ...
    FlexWordpress\Package\Query\V1\Cascade\Taxonomy\V1\Contract\Query as QueryTaxonomyContract
};

abstract class Query extends BaseQuery implements QueryTaxonomyContract
{
    /**
