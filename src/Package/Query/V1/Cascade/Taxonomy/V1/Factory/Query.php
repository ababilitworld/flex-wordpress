<?php
namespace Ababilithub\FlexWordpress\Package\Query\V1\Cascade\Taxonomy\V1\Factory;

(defined('ABSPATH') && defined('WPINC')) || exit();

use Ababilithub\{
    FlexPhp\Package\Factory\V1\Base\Factory as BaseFactory,
    FlexWordpress\Package\Query\V1\Cascade\Taxonomy\V1\Contract\Query as QueryContract,
};
